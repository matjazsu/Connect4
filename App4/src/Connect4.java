...
public class Connect4 extends JFrame implements ActionListener {
	...
	public static final int HUMANVSRANDOMPLAYERS = 1; // Always starts geek than random program
	public static final int HUMANVSMINMAXPLAYERS = 2; // Always starts geek than random program
	...
	public static int sestevekRed = 0;
	public static int sestevekYellow = 0;
	public static int sestevekSum = 0;  
	private JTextField txtCasIzvedbe; 
	...
	public Connect4(){
		...
		JLabel lblCreator = new JLabel("Matjaz Suber");
		...
		txtYellow.setText("" + sestevekYellow);
		...
		JLabel lblasIzvedbe = new JLabel(" \u010Cas izvedbe:");
		GridBagConstraints gbc_lblasIzvedbe = new GridBagConstraints();
		gbc_lblasIzvedbe.anchor = GridBagConstraints.EAST;
		gbc_lblasIzvedbe.insets = new Insets(0, 0, 0, 5);
		gbc_lblasIzvedbe.gridx = 0;
		gbc_lblasIzvedbe.gridy = 6;
		infoPanel.add(lblasIzvedbe, gbc_lblasIzvedbe);

		txtCasIzvedbe = new JTextField();
		txtCasIzvedbe.setEditable(false);
		...
		infoPanel.add(txtCasIzvedbe, gbc_txtCasIzvedbe);
		txtCasIzvedbe.setColumns(10);
	...
	private void InitializeArray() {
		...
		gameStart=false;
		this.sestevekRed = 0;
		this.txtRed.setText("" + sestevekRed);
		this.sestevekYellow = 0;
		this.txtYellow.setText("" + sestevekYellow);
		this.sestevekSum =0;
		this.txtSum.setText("" + sestevekSum);
		activeColour = RED;
		activePlayers = HUMANPLAYERS;
		this.txtCasIzvedbe.setText("0ms");
	...
	public void humanPlay(int n){
		try{
			...
			if(activePlayers == HUMANVSRANDOMPLAYERS && !end && canPlay){
				...
				putDisk(randomPlayer.vrniStolpec(this.theArray));
			...
			if(activePlayers == HUMANVSMINMAXPLAYERS && !end &&canPlay){
				...
				putDisk(minMaxPlayer.vrniStolpec());
	...
	public void putDisk(int n) {
		...
		if (row>0) {
			...
			if (activeColour==RED){
				activeColour=YELLOW;
				this.sestevekRed++;
				this.sestevekSum = sestevekRed + sestevekYellow;
				this.txtRed.setText("" + sestevekRed);
			}   
			else{
				activeColour=RED;
	...
	public void ShowTime(long startTime, long endTime) {
		...
		this.txtCasIzvedbe.setText("" + time);
